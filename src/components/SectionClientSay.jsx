...
const DEMO_DATA = [
  {
    id: 1,
    clientName: 'Hashim Amla Abie',
    clientAddress: 'Karachi Pakistan',
    content:
      'This place is exactly like the picture posted on Facebook. Great service, we had a great stay!',
  },
  {
    id: 2,
    clientName: 'Hamza Ibramhim',
  ...
  {
    id: 3,
    clientName: 'Nazir Bashir',
    clientAddress: 'Sheikhupura Pakistan',
    content:
      'This place is exactly like the picture posted on Facebook. Great service, we had a great stay!',
  },
];
...
const SectionClientSay = ({className = '', data = DEMO_DATA}) => {
  ...
  return (
    <div className={`nc-SectionClientSay relative ${className} `}>
      <Heading desc="Let's see what people think of EasyStay" isCenter>
